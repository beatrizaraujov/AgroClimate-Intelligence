...
export default function Header() {
  ...
  return (
    <section className="bg-white w-full border-b border-slate-100 py-4">
      <div className="flex justify-between px-4 max-w-7xl mx-auto items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <img src="/agroClimate.svg" alt="AgroClimate" className="h-10" />
        </div>
        ...
        <div className="flex items-center rounded-full bg-[#F1F5F9] px-4 py-2 gap-2 border border-transparent focus-within:border-emerald-500/30 focus-within:bg-white transition-all">
